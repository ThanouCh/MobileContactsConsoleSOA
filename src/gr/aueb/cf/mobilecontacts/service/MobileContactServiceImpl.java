...
public class MobileContactServiceImpl implements IMobileContactService {
    ...
    public MobileContact getContactById(Long id) throws ContactNotFoundException {
        ...
        try {
            ...
            if (mobileContact == null) {
                throw new ContactNotFoundException("Contact with id: " + id + " no found");
            }
    ...
    public MobileContact getContactByPhoneNumber(String phoneNumber) throws ContactNotFoundException {
        ...
        try {
            ...
            if (mobileContact == null) {
                throw new ContactNotFoundException("Contact with phone number: " + phoneNumber + " no found");
            }
            return mobileContact;
        } catch (ContactNotFoundException e) {
            System.err.printf("Contact with phone number: %d was not found to get returned\n", phoneNumber);
            throw e;
        }
    }
    ...
    public void deleteContactByPhoneNumber(String phoneNumber) throws ContactNotFoundException {
        try {
            ...
            System.err.printf("MobileContactServiceImpl Logger: contact with phone number: %d was deleted\n", phoneNumber);
